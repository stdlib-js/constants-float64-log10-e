...
```javascript
LOG10E = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float64-log10-e@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/constants-float64-log10-e@umd/bundle.js"></script>
```
