...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/constants-float64-log10-e/tags). For example,

```javascript
LOG10E = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float64-log10-e@v0.0.8-umd/browser.js' )
```
